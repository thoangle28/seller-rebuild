...
const Sidebar: FC = () => {
  ...
  const {personal_photo, firstname, lastname} = infoUser
    ...
    return isDisplaying ? (
      <>
        ...
        <div className='sidebar__navigation pb-4'>
          ...
          <button onClick={signOut} className='signout-button btn btn-primary'>
            Sign Out
          </button>
        </div>
      </>
        ...
        {isLoading ? (
          ...
          <>
            <div className='user-avatar'>
              <img
                src={personal_photo ? personal_photo : userPlaceholder}
                className='rounded-circle user-avatar__img'
                alt='avatar'
              />
            </div>
            <div
              className='user-name d-flex justify-content-center align-items-center cursor-pointer'
