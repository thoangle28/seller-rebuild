...
const infoData: iInfoData[] = [
    { title: 'Promotion Products', subtitle: 'Products', icon: faChartSimple, number: 10 },
    ...
    { title: 'Tickets Report', subtitle: 'Products', icon: faTicketSimple, number: 3 },
]
    ...
    const renderInfoTags = () => {
        return <div className="row">
            {infoData.map(item => {
                ...
                return <div className="col-sm-6 col-md-3 pe-0">
                    <InfoTag icon={icon} number={number} subTitle={subtitle} title={title} />
                </div>
            })}
                            ...
                            <div className="col-md-8">
                                <div className="d-flex justify-content-end flex-column">
                                    ...
                                    <div className="month-list d-flex justify-content-end align-items-center flex-wrap flex-row">
                                        {MONTHS.map(month => {
                                            return <div key={month.name} className='cursor-pointer month-list__item mb-2' onClick={() => setCurrentMonth(month)}>
